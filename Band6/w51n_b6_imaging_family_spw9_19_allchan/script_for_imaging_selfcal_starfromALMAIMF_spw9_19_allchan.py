...
if not os.path.exists(contvis):
    print("Splitting out the continuum data from the calibrated measurement set")
    raise ValueError("Need to split out the continuum data from the calibrated measurement set first.  Please run the split command in the script.")
contvis = 'calibrated_final_cont_spw9_19_allchan.ms'
