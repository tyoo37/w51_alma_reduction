...
#SBATCH --output=w51n_b6_spw9_19_allchan_%j.log
#SBATCH --job-name=w51n_b6_spw9_19_allchan
#SBATCH --export=ALL

export FIELD_ID="W51"
export BAND_TO_IMAGE=B6
export LOGFILENAME="casa_log_w51n_b6_spw9_19_allchan_sm_${FIELD_ID}_${BAND_TO_IMAGE}_12M_$(date +%Y-%m-%d_%H_%M_%S).log"

WORK_DIR='/orange/adamginsburg/w51/2017.1.00293.S/uvdata'
WORK_DIR='/orange/adamginsburg/w51/2017.1.00293.S/may2021_imaging'
WORK_DIR='/orange/adamginsburg/w51/TaehwaYoo/w51n_b6_imaging_family_spw9_19_allchan/'
...
imaging_script=/orange/adamginsburg/w51/TaehwaYoo/w51n_b6_imaging_family_spw9_19_allchan/script_for_imaging_selfcal_starfromALMAIMF_spw9_19_allchan.py
cd ${WORK_DIR}
echo ${WORK_DIR}
