...
#SBATCH --output=w51e_b6_allspw_linefree_%j.log
#SBATCH --job-name=w51e_b6_allspw_linefree
#SBATCH --export=ALL
...
WORK_DIR='/orange/adamginsburg/w51/TaehwaYoo/w51e_b6_imaging_family_allspw_linefree/'
...
imaging_script=/orange/adamginsburg/w51/TaehwaYoo/w51e_b6_imaging_family_allspw_linefree/script_for_imaging_selfcal_starfromALMAIMF_allspw_linefree.py
cd ${WORK_DIR}
echo ${WORK_DIR}
