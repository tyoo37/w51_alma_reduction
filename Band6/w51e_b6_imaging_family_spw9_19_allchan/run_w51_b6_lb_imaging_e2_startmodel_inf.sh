...
#SBATCH --output=w51e_b6_spw9_19_allchan_%j.log
#SBATCH --job-name=w51e_b6_spw9_19_allchan
#SBATCH --export=ALL
...
WORK_DIR='/orange/adamginsburg/w51/TaehwaYoo/w51e_b6_imaging_family_spw9_19_allchan/'
...
imaging_script=/orange/adamginsburg/w51/TaehwaYoo/w51e_b6_imaging_family_spw9_19_allchan/script_for_imaging_selfcal_starfromALMAIMF_spw9_19_allchan.py
cd ${WORK_DIR}
echo ${WORK_DIcR}
